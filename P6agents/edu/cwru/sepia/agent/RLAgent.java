...
public class RLAgent extends Agent {
    ...
    public Map<Integer, Action> middleStep(State.StateView stateView, History.HistoryView historyView) {
        ...
        if (ifEventOccured(stateView, historyView)){
            for (int footmanId : myFootmen) {
                ...
                //Update the weights
                updateWeights(weightsPrimitive, featureVector, totalRewards.get(footmanId), stateView, historyView, footmanId);
            }
    ...
    public double[] calculateFeatureVector(State.StateView stateView,
        ...
        double featureHPRatio = stateView.getUnit(attackerId).getHP() / stateView.getUnit(defenderId).getHP();

        return new double[]{featureConstant, featureIsClosestChebyshevEnemy, featureOtherFootmenAttackingE, featureIsEAttackingMe, featureHPRatio};
    }
